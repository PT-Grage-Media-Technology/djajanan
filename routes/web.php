...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/pengiriman', [TipePengirimanController::class, 'index'])->name('pengiriman.index')->middleware('permission:main-admin');
    Route::get('/pengiriman/edit/{id}', [TipePengirimanController::class, 'edit'])->name('pengiriman.edit')->middleware('permission:main-admin');
    Route::post('/pengiriman/update/{id}', [TipePengirimanController::class, 'update'])->name('pengiriman.update')->middleware('permission:main-admin');
    Route::post('/pengiriman/store', [TipePengirimanController::class, 'store'])->name('pengiriman.store')->middleware('permission:main-admin');
    Route::get('/pengiriman/create', [TipePengirimanController::class, 'create'])->name('pengiriman.create')->middleware('permission:main-admin');
});
