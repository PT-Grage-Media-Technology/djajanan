            ...
            <div class="container-profile">
                @forelse($roleRequests as $request)
                    <div class="card-profile">
                        ...
                        <img src="https://djajanan.com/{{ $request->img ? $request->img : 'img/client-1.png' }}" alt="Profile Picture" loading="lazy">
                        <h2>{{ $request->name }}</h2>
                        <div class="info">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative  w-8 h-8 mr-3 rounded-full md:block">
                                                    <img class="object-cover w-full h-full rounded-full"
                                                        src="https://djajanan.com/{{ $request->img ? $request->img : 'img/client-1.png' }}" alt="" loading="lazy" />
