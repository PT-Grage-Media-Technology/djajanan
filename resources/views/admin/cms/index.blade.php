                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div class="relative w-8 h-8 mr-3 rounded-full"> <!-- Menghapus class hidden -->
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="https://djajanan.com/{{ $company->gambar_home_1 }}"
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-8 h-8 mr-3 rounded-full"> <!-- Menghapus class hidden -->
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="https://djajanan.com/{{ $company->gambar_home_2 }}"
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-8 h-8 mr-3 rounded-full"> <!-- Menghapus class hidden -->
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="https://djajanan.com/{{ $company->gambar_home_3 }}"
                                ...
                                <td class="px-6 py-3">
                                    <div class="flex items-center text-sm">
                                        <div class="relative w-8 h-8 mr-3 rounded-full"> <!-- Menghapus class hidden -->
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="https://djajanan.com/{{ $company->logo }}"
