<div x-data="{ isOpen: false }" @click.away="isOpen = false" class="relative inline-block" id="dropdown">
    ...
    <button
        ...
        @click="isOpen = !isOpen">
        <img class="w-full object-cover" src="https://djajanan.com/{{ Auth::user()->img ?? 'img/client-1.png' }}"
    ...
    <div x-show="isOpen" id="opened"
                ...
                <div class="flex gap-3 items-center">
                    <div
                        ...
                        <img class="w-full object-cover"
                            src="https://djajanan.com/{{ Auth::user()->img ?? '/img/client-1.png' }}"
                            alt="Profile" loading="lazy">
                    </div>
                    <div style="width: 100%">
        ...
        @else
            ...
            <p>Tolong Login Terlebih Dahulu.</p>
            <a href="/log-reg">
                <button type="button"
...
<div class="container-profile" id="profileCard">
    <div class="profile-card">
        ...
        <div class="profile-pic">
            <img src="https://djajanan.com/{{ Auth::user()->img ?? '/img/client-1.png' }}" alt="user avatar" loading="lazy">
        </div>
