            ...
            @if (Auth::user()->hasRole('seller'))
                <div class="store-header">
                    <div class="store-info">
                        <!-- <img src="https://djajanan.com/store_image/{{ $toko->foto_profile_toko ?  $toko->foto_profile_toko : 'markets.png' }} "alt="logo toko" class="store-logo"> -->
                        ...
                        <div class="edit-button-container max-sm:hidden">
                    ...
                    <div class="edit-button-container maz-sm:mt-5 md:hidden">
                        <a href="/seller/edit_toko/{{ $toko->id_toko }}">
                            <button type="button"
                                class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Edit
                                Toko
                        ...
                        @else
                            @foreach ($product as $p)
                                ...
                                <div class="product-box">
                                    ...
                                    <img alt="pack" src="https://djajanan.com/{{ $p->photo }}" loading="lazy">
                                    ...
                                    <div class="flex">
                                        ...
                                        @if ($average_rating >= 1)
                                            <p class="mx-2">( {{ $average_rating }} / 5 ) {{ $rated_by }} Pcs</p>
                                        @else
                                            <p class="mx-2">( 0 / 0 )</p>
                                        @endif
                                    </div>
