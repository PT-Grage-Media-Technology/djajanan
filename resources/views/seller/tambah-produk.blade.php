        ...
        <div class="container mx-auto max-w-md mt-5 p-5 bg-gray-800 shadow-lg rounded-lg text-left">
            <form>
                ...
                <div class="form-group mb-5">
                    ...
                    <textarea id="deskripsi-produk" name="deskripsi-produk" rows="4" placeholder="Masukkan deskripsi produk" required
                        class="w-full p-2 border border-gray-700 rounded bg-gray-700 text-white resize-none"></textarea>
                </div>
                <div class="form-group mb-5">
                    <label for="kategori-produk" class="block mb-1 text-gray-400">Kategori Produk</label>
                    <div class="relative">
                        <select id="kategori-produk" name="kategori-produk"
                            class="w-full p-2 border border-gray-700 rounded bg-gray-700 text-white appearance-none"
                            required>
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="file" id="upload-img" name="upload-img" accept="image/*" onchange="previewImage(event)"
                        class="w-full p-2 border border-gray-700 rounded bg-gray-700 text-white" loading="lazy">
                ...
                <button type="submit" class="w-full p-2 bg-blue-500 text-white rounded hover:bg-gray-600">Tambah
                    Produk</button>
            </form>
        </div>
